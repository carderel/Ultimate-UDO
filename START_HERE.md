...
## CAPABILITY DETECTION (FIRST RUN ONLY)

On your first session with this project, detect your environment and update CAPABILITIES.json:

1. **Identify your environment:**
   - Claude CLI (claude code command line)
   - Claude Web (claude.ai browser interface)
   - ChatGPT Web
   - API integration
   - Other

2. **Test your capabilities:**
   - Can you read files? (Try reading this file)
   - Can you write/create files?
   - Can you execute bash commands?
   - Can you search the web?
   - Can you analyze images?
   - Do you have MCP tools available?

3. **Update CAPABILITIES.json** with actual boolean values for your environment.

4. **Report your capabilities:**
   "Environment: [detected environment]
   Capabilities: file_read, file_write, bash_commands, [etc.]
   Limitations: [what you cannot do]"

If you cannot write to CAPABILITIES.json, tell the user what to put in it.
...
5. Read CAPABILITIES.json (environment and limits) - update if first run
...
| Detect capabilities | Re-run capability detection |
